...
class QTerminalWidget(QWidget):
    ...
    colors = {
        ...
        'red': QColor(250, 5, 5),
        'green': QColor(22, 198, 12),
        'blue': QColor(38, 104, 255),
    ...
    def __init__(self, parent=None, host=None, user=None, password = None):
        ...
        # self.pixmap.setTextInteractionFlags(Qt.TextSelectableByMouse)
...
class QTerminal(QWidget):
    ...
    def __init__(self,host=None, user=None, password=None):
        ...
        self.term = QTerminalWidget(self, host, user,password)
...
if __name__ == "__main__":
    try:
        ...
        win = QTerminal(host='example', user='pc', password='132')
        win.show()
        sys.exit(app.exec_())
    except:
        traceback.print_exc()
